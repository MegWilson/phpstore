...
<head>
  ...
  <title>Sushi Art Print - Megan Wilson Prints</title>
...
<?php include "header.php";?>
	<!-- Main Content -->
		<div class="main-content row">
			<div class="col">
				<h2>"Sushi" Art Print</h2>
			</div>
		
		<div class="product-page">
			<div class="row">
				<div class="col product-image">
					<img src="./images/print4.png" alt="Sushi Art Print">
				...
				<div class="col">
					...
					<input type="hidden" name="productname" value="sushi">
